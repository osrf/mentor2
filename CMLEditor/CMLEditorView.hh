...
#ifndef _CML_EDITOR_VIEW_HH_
#define _CML_EDITOR_VIEW_HH_
...
namespace gazebo
{
  namespace gui
  {
    /// \class CMLEditorView CMLEditorView.hh
    /// \brief Control the editor view and manage contents in the editor scene.
    class CMLEditorView : public QGraphicsView
    {
      Q_OBJECT

      /// \brief Constructor
      /// \param[in] _parent Parent Widget.
      public: CMLEditorView(QWidget *_parent = 0);

      /// \brief Destructor
      public: ~CMLEditorView();
